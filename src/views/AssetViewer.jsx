...
import {
    AssetImpactSummary,
    AssetHazardSummary,
} from "../components/AssetImpactSummary"
...
export default function AssetViewer(props) {
                ...
                if (!portfolio.items) {
                    portfolio = {
                        items: [
                            {
                                asset_class:
                                    "Invalid file; no asset items found.",
                            },
                        ],
                    }
                }
    ...
    useEffect(() => {
        if (portfolio?.calculationResult) {
            let dataTableRows = createDataTable(
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <MenuButton
                            buttonText="Example portfolios"
                            buttonIcon={<List />}
                            menuOptions={Object.keys(
                                portfolio.examplePortfolios
                            )}
                            onPortfolioSelected={(portfolioName) =>
                                loadExamplePortfolio(
                                    portfolio,
                                    portfolioDispatch,
                                    portfolioName,
