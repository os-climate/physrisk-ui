    ...
    switch (action.type) {
        case "initialise":
            ...
            return {
                ...
                mapColorbar: action.payload.inventory.getColorbar(""),
        ...
        case "update":
            ...
            var [hazard, model, scenario, year] = selection
            const mapId = state.inventory.getMapId(hazard, model.id, scenario.id, year)
            return {
                ...state,
                selectedIndices: newSelectedIndices,
                selection: selection,
                mapId: mapId,
                mapColorbar: state.inventory.getColorbar(mapId),
                menuOptions: menuOptions 
            };
      default:
        return state;
...
function getColorbar()
{
    ...
    const colorbar = [...Array(n).keys()].map(i => 
        ({ 
