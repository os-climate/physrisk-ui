...
export const hazardMenuReducer = (state, action) => {
    switch (action.type) {
        case "initialise":
            ...
            var [mapId, colorbar] = action.payload.inventory.getMapIdColorbar(
                hazardTypeId,
                model.id,
                scenario.id,
                year
        ...
        case "update":
            ...
            var [mapId, colorbar] = state.inventory.getMapIdColorbar( // eslint-disable-line no-redeclare
                hazardTypeId,
                model.id,
                scenario.id,
                year
...
function getColorbar(colormap) {
    ...
    return {
        stops: stops,
        minValue: colormap["min"]["data"],
        maxValue: colormap["max"]["data"],
